...
#'
#' @param population_data Data frame containing population environmental data
#' @param sample_data Data frame containing sample environmental data  
#' @param n_bins Number of histogram bins for distribution comparison (default: 25)
#'
#' @return Numeric value representing mean KL divergence across all variables
#' @keywords internal
...
#'
#' @param population_data Data frame containing population environmental data
#' @param min_samples Minimum number of samples to test (default: 10)
#' @param max_samples Maximum number of samples to test (default: 500)
#' @param step_size Step size for sample size sequence (default: 10)
#' @param n_replicates Number of replicates per sample size (default: 10)
#' @param n_bins Number of histogram bins for KL divergence (default: 25)
#' @param probability_threshold Probability threshold for optimal size (default: 0.95)
#'
#' @return List containing optimization results, plots, and optimal sample size
#' @export
